    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        {[
          ...
          { label: 'Storage Used', value: stats.storageUsed, icon: Folder, color: 'bg-bg-secondary text-fg-secondary border-border-secondary' },
        ].map((stat) => (
          <div
            key={stat.label}
      ...
      <div className="grid gap-8 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-8">
          <section className="bg-card rounded-xl border border-border p-6 shadow-sm">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
               <Link href="/dashboard/content/courses" className="group p-4 rounded-xl border border-border hover:border-primary-200 hover:shadow-sm transition-all bg-card flex items-start gap-4">
                 <div className="bg-blue-50 p-2.5 rounded-lg text-blue-600 group-hover:bg-blue-100 transition-colors">
                   <BookOpen className="h-6 w-6" />
                 </div>
                 <div>
                   <h3 className="font-semibold text-fg group-hover:text-primary-700">Course Content</h3>
                   <p className="text-sm text-fg-muted mt-1">Edit and organize course materials.</p>
                 </div>
               </Link>

               <Link href="/dashboard/content/media" className="group p-4 rounded-xl border border-border hover:border-primary-200 hover:shadow-sm transition-all bg-card flex items-start gap-4">
                 <div className="bg-purple-50 p-2.5 rounded-lg text-purple-600 group-hover:bg-purple-100 transition-colors">
                   <Video className="h-6 w-6" />
                 </div>
                 <div>
                   <h3 className="font-semibold text-fg group-hover:text-primary-700">Media Library</h3>
                   <p className="text-sm text-fg-muted mt-1">Manage videos, images, and documents.</p>
                 </div>
               </Link>
            </div>
          </section>
          ...
          <section className="bg-card rounded-xl border border-border p-6 shadow-sm">
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={i} className="flex items-center justify-between p-3 rounded-lg border border-border-secondary hover:bg-bg-secondary transition-colors">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-lg bg-bg-secondary flex items-center justify-center text-fg-muted">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-fg-muted">{file.type} • {file.size}</p>
                    </div>
                  </div>
                  <span className="text-xs text-fg-muted">{file.time}</span>
                </div>
              ))}
            </div>
          </section>
        ...
        <div className="space-y-6">
          <div className="bg-card rounded-xl border border-border p-6 shadow-sm">
            <h2 className="text-lg font-bold font-display text-fg mb-4">Storage Status</h2>
            <div className="space-y-4">
              <div>
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm font-medium text-slate-700">Total Usage</span>
                  <span className="text-sm font-bold text-fg">45.2 GB / 1 TB</span>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4 pt-2">
                <div className="p-3 bg-slate-50 rounded-lg text-center">
                  ...
                  <p className="text-sm font-bold text-fg">38.4 GB</p>
                </div>
                <div className="p-3 bg-slate-50 rounded-lg text-center">
                  <p className="text-xs text-fg-muted">Documents</p>
                  <p className="text-sm font-bold text-fg">6.8 GB</p>
                </div>
              </div>
            </div>
          </div>
