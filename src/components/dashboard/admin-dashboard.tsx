        ...
        <div className="lg:col-span-2 space-y-8">
          <section className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
               <Link href="/dashboard/admin/users" className="group p-4 rounded-xl border border-slate-200 hover:border-primary-200 hover:shadow-sm transition-all bg-white flex items-start gap-4">
                 <div className="bg-blue-50 p-2.5 rounded-lg text-blue-600 group-hover:bg-blue-100 transition-colors">
                   <Users className="h-6 w-6" />
                 </div>
                 <div>
                   <h3 className="font-semibold text-slate-900 group-hover:text-primary-700">User Management</h3>
                   <p className="text-sm text-slate-500 mt-1">Manage users, roles, and permissions.</p>
                 </div>
               </Link>

               <Link href="/dashboard/admin/courses" className="group p-4 rounded-xl border border-slate-200 hover:border-primary-200 hover:shadow-sm transition-all bg-white flex items-start gap-4">
                 <div className="bg-indigo-50 p-2.5 rounded-lg text-indigo-600 group-hover:bg-indigo-100 transition-colors">
                   <BookOpen className="h-6 w-6" />
                 </div>
                 <div>
                   <h3 className="font-semibold text-slate-900 group-hover:text-primary-700">Course Administration</h3>
                   <p className="text-sm text-slate-500 mt-1">Review and approve courses.</p>
                 </div>
               </Link>
               
               <Link href="/dashboard/admin/finance" className="group p-4 rounded-xl border border-slate-200 hover:border-primary-200 hover:shadow-sm transition-all bg-white flex items-start gap-4">
                 <div className="bg-green-50 p-2.5 rounded-lg text-green-600 group-hover:bg-green-100 transition-colors">
                   <DollarSign className="h-6 w-6" />
                 </div>
                 <div>
                   <h3 className="font-semibold text-slate-900 group-hover:text-primary-700">Financial Overview</h3>
                   <p className="text-sm text-slate-500 mt-1">View revenue, payouts, and transactions.</p>
                 </div>
               </Link>

               <Link href="/dashboard/admin/settings" className="group p-4 rounded-xl border border-slate-200 hover:border-primary-200 hover:shadow-sm transition-all bg-white flex items-start gap-4">
                 <div className="bg-slate-50 p-2.5 rounded-lg text-slate-600 group-hover:bg-slate-100 transition-colors">
                   <Settings className="h-6 w-6" />
                 </div>
                 <div>
                   <h3 className="font-semibold text-slate-900 group-hover:text-primary-700">System Settings</h3>
